...
void main() {
  group('MonthlyAttendanceRepository', () {
    ...
    test('loads persisted month cache without touching the monthly API', () async {
      ...
      expect(
        result.monthlyData['2026-06-01']?[SmartDayTypeHelper.dataSourceStatusKey],
        isNull,
      );
    });

    test('force refresh merges API data, saved marks, and persists cache', () async {
      final storage = StorageService();
